...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_Ch /home/my_notebooks/Week3/x86_64/Na_Channel.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   mAlpha = ( 0.182 * ( ( v - 10.0 ) - - 35.0 ) ) / ( 1.0 - ( exp ( - ( ( v - 10.0 ) - - 35.0 ) / 9.0 ) ) ) ;
   if ( v  == - 25.0 ) {
     v = v + 0.000001 ;
     }
   mBeta = ( 0.124 * ( - ( v - 10.0 ) - 35.0 ) ) / ( 1.0 - ( exp ( - ( - ( v - 10.0 ) - 35.0 ) / 9.0 ) ) ) ;
   mInf = mAlpha / ( mAlpha + mBeta ) ;
   mTau = 1.0 / ( mAlpha + mBeta ) ;
   hInf = 1.0 / ( 1.0 + exp ( ( v - - 65.0 - 10.0 ) / 6.2 ) ) ;
   if ( v  == - 40.0 ) {
     v = v + 0.000001 ;
     }
   hTau = 1.0 / ( ( 0.024 * ( ( v - 10.0 ) - - 50.0 ) ) / ( 1.0 - ( exp ( - ( ( v - 10.0 ) - - 50.0 ) / 5.0 ) ) ) + ( 0.0091 * ( - ( v - 10.0 ) - 75.000123 ) ) / ( 1.0 - ( exp ( - ( - ( v - 10.0 ) - 75.000123 ) / 5.0 ) ) ) ) ;
     return 0; }
