...
#define nrn_init _nrn_init__SimpleAMPA_NMDA
#define _nrn_initial _nrn_initial__SimpleAMPA_NMDA
#define nrn_cur _nrn_cur__SimpleAMPA_NMDA
#define _nrn_current _nrn_current__SimpleAMPA_NMDA
#define nrn_jacob _nrn_jacob__SimpleAMPA_NMDA
#define nrn_state _nrn_state__SimpleAMPA_NMDA
#define _net_receive _net_receive__SimpleAMPA_NMDA 
#define odes odes__SimpleAMPA_NMDA 
...
#define factor_AMPA _p[22]
#define factor_NMDA _p[23]
#define v _p[24]
#define _g _p[25]
#define _tsav _p[26]
...
#define _gth 0
#define mggate_SimpleAMPA_NMDA _thread1data[0]
#define mggate _thread[_gth]._pval[0]
 ...
 "mggate_SimpleAMPA_NMDA", &mggate_SimpleAMPA_NMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 SimpleAMPA_NMDA /home/my_notebooks/week8/x86_64/SimpleAMPA_NMDA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "AMPA and NMDA glutamate receptor";
